...
class PDF extends FPDF
{
	...
	$pdf ->cell(120);
	$pdf ->cell(110,9,'LAPORAN DATA SK Tidak Mampu ',0,1,'C');
	$pdf ->Ln(4);
...
$pdf->cell(40,10,'NIK',1,0,'C',0);
$pdf->cell(40,10,'NO KK',1,0,'C',0);
$pdf->cell(50,10,'Nama',1,0,'C',0);
$pdf->cell(40,10,'Email',1,0,'C',0);
$pdf->cell(60,10,'Keperluan',1,0,'C',0);
$pdf->cell(60,10,'Tanggal Permohonan',1,0,'C',0);
$pdf->cell(40,10,'Ststus',1,1,'C',0);
 ...
 $i=1;
    ...
    if(isset($_POST["tampilkan"])){
                     ...
                     $sql = mysqli_query($koneksi,"SELECT * FROM sk_tidakmampu
                                                JOIN t_penduduk USING(id_penduduk)  where tgl_permohonan BETWEEN '$dt1' AND '$dt2'");
                     }else{
  	...
  	$pdf->cell(40,10,$data['nik'],1,0,'L',0);
  	$pdf->cell(40,10,$data['no_kk'],1,0,'L',0);
  	$pdf->cell(50,10,$data['nama_lengkap'],1,0,'L',0);
  	$pdf->cell(40,10,$data['email'],1,0,'L',0);
  	$pdf->cell(60,10,$data['keperluan'],1,0,'L',0);
  	$pdf->cell(60,10,$data['tgl_permohonan'],1,0,'L',0);

  	$pdf->cell(40,10,$data['persetujuan'],1,1,'L',0);
