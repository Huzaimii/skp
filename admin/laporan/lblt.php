...
class PDF extends FPDF
{
	...
	$pdf ->cell(120);
	$pdf ->cell(110,9,'LAPORAN HASIL SELEKSI DANA BANTUAN LANGSUNG TUNAI',0,1,'C');
	$pdf ->Ln(4);
...
$ket =$_POST['ket'];
                      $sql = mysqli_query($koneksi,"SELECT * FROM dana_blt
  	...
  	$pdf->cell(32,10,$data['pertanyaan4'],1,0,'L',0);
  	$pdf->cell(35,10,$data['penghasilan'],1,0,'L',0);
  	$pdf->cell(45,10,$data['kondisi_rumah'],1,0,'L',0);
