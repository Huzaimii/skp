...
<center>
  ...
  <tr>
    <td style="font-size: 25px; font-weight: bold;">Laporan Data Surat Keterangan Usaha</td><br>	<br>	
  </tr>
  ...
  <table class="isi" style="width: 100%;" align="center" border="1">
    ...
    <thead>
                     ...
                     $sql = mysqli_query($koneksi,"SELECT * FROM sk_usaha
                                                JOIN t_penduduk USING(id_penduduk)  WHERE tgl_berdiri BETWEEN '$tgl1' AND '$tgl2'");
                                                ?>
                                                <i><b>Informasi : </b> Hasil pencarian data berdasarkan periode Tanggal <b><?php echo $_POST['tgl1']?></b> s/d <b><?php echo $_POST['tgl2']?></b></i><br>	<br>	
