...
class PDF extends FPDF
{
	...
	$pdf ->cell(120);
	$pdf ->cell(110,9,'LAPORAN HASIL SELEKSI DANA BANTUAN BNPT',0,1,'C');
	$pdf ->Ln(4);
...
$ket =$_POST['ket'];
                      $sql = mysqli_query($koneksi,"SELECT * FROM dana_bnpt
  	...
  	$pdf->cell(32,10,$data['kondisirumah'],1,0,'L',0);
  	$pdf->cell(35,10,$data['penghasilantetap'],1,0,'L',0);
  	$pdf->cell(45,10,$data['tidakmampuberobat'],1,0,'L',0);
