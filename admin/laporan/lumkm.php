...
class PDF extends FPDF
{
	...
	$pdf ->cell(120);
	$pdf ->cell(110,9,'LAPORAN HASIL SELEKSI DANA BANTUAN UMKM',0,1,'C');
	$pdf ->Ln(4);
...
$pdf->cell(32,10,'memiliki usaha mikro',1,0,'C',0);
$pdf->cell(35,10,'Bukan Aparator Negara',1,0,'C',0);
$pdf->cell(45,10,'Tidak Sedang Menerima KUR',1,0,'C',0);
...
$ket =$_POST['ket'];
  	...
  	$pdf->cell(32,10,$data['pertanyaan5'],1,0,'L',0);
  	$pdf->cell(35,10,$data['pertanyaan2'],1,0,'L',0);
  	$pdf->cell(45,10,$data['pertanyaan7'],1,0,'L',0);
  	$pdf->cell(43,10,$data['pertanyaan3'],1,0,'L',0);
